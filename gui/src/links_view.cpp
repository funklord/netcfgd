/*
 * links_view.cpp -- the devices table described in links_view.h.
 */
...
ncfg_links_view::ncfg_links_view(ncfg_connection *connection, QWidget *parent)
    : QWidget(parent), connection(connection)
{
	...
	connect(configure_button, &QPushButton::clicked, this,
	    &ncfg_links_view::configure_selected);
	connect(table, &ncfg_table_view::activated, this, &ncfg_links_view::configure_selected);
	connect(explain_button, &QPushButton::clicked, this, &ncfg_links_view::explain_selected);
	connect(group_button, &QPushButton::clicked, this, &ncfg_links_view::new_linkset);
...
void ncfg_links_view::rebuild_filter()
{
	QStringList present;
...
void ncfg_links_view::explain_selected()
{
...
void ncfg_links_view::configure_selected()
{
...
void ncfg_links_view::new_linkset()
{
	configure_linkset(QString());
}

void ncfg_links_view::configure_linkset(const QString &name)
{
...
void ncfg_links_view::configure_network(const QString &id)
{
