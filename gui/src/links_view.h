/*
 * links_view.h -- what this machine's network is doing.
 *
 ...
 */
#ifndef NCFG_LINKS_VIEW_H
#define NCFG_LINKS_VIEW_H
...
class ncfg_links_view : public QWidget {
	Q_OBJECT

public:
	explicit ncfg_links_view(ncfg_connection *connection, QWidget *parent = nullptr);
