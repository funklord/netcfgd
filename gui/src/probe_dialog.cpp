...
const char *const starting_script =
    ...
    "# exists to catch.\n"
    "#\n"
    "# On a cellular link a ping is not enough, and that is measured rather than\n"
    "# cautious: a modem attached on the wrong APN carries ICMP everywhere and\n"
    "# accepts connections to the well-known resolvers, while every other address\n"
    "# blackholes the SYN. Open a TCP connection or fetch a URL instead -- probe\n"
