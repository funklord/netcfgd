# gui/tests/live/live_linkset.pro -- the group editor against a real daemon.
#
...
SOURCES += live_linkset.cpp ../../src/ncfg_connection.cpp ../../src/linkset_dialog.cpp
HEADERS += ../../src/ncfg_connection.h ../../src/linkset_dialog.h
