# gui/tests/live/live_add_dialog.pro -- the add dialog against a real daemon.
#
...
SOURCES += live_add_dialog.cpp ../../src/ncfg_connection.cpp \
	../../src/add_network_dialog.cpp
HEADERS += ../../src/ncfg_connection.h ../../src/add_network_dialog.h
