# gui/tests/live/live_rule.pro -- the rule editor against a real daemon.
#
...
SOURCES += live_rule.cpp ../../src/ncfg_connection.cpp ../../src/rule_dialog.cpp
HEADERS += ../../src/ncfg_connection.h ../../src/rule_dialog.h
