...
1. **Decide the modem backend.** ModemManager (D-Bus, therefore an optional package by constraint 3) or QMI/MBIM directly (large, keeps the dependency posture). Deserves its own record before any code.
