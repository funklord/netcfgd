...
2. **Build the OpenVPN tunnel** that [0046](docs/decisions/0046-the-ovpn-file-is-the-operators.md) settles: `InterfaceKind::OpenVpn` pointing at the operator's `.ovpn`, supervised like a PPPoE session and stopped through its management socket. Credentials and who-configures-the-tunnel are named in the record as deliberately out of the first slice.
