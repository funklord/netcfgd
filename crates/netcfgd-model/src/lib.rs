...
pub use observed::{
	...
	ObservedAddress, ObservedBackend, ObservedBridgeVlan, ObservedLink, ObservedPolicy,
	ObservedReport, ObservedRoute, ObservedRule, ObservedWgPeer, ObservedWireGuard, Origin,
