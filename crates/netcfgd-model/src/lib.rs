...
pub use observed::{
	...
	ObservedAddress, ObservedBackend, ObservedBridge, ObservedBridgeVlan, ObservedLink,
	ObservedPolicy, ObservedReport, ObservedRoute, ObservedRule, ObservedWgPeer, ObservedWireGuard,
